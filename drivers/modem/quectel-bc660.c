#define DT_DRV_COMPAT quectel_bc660

#include <zephyr/logging/log.h>
LOG_MODULE_REGISTER(modem_quectel_bc660, CONFIG_MODEM_LOG_LEVEL);
...
static K_KERNEL_STACK_DEFINE(modem_rx_stack, CONFIG_MODEM_QUECTEL_BC660_RX_STACK_SIZE);
...
static void pin_init(void)
{
	...
	/* NOTE: Per the BC660 document, the Reset pin is internally connected to the
	 * Power key pin.
	 */
...
NET_DEVICE_DT_INST_OFFLOAD_DEFINE(0, modem_init, NULL,
				  &mdata, NULL,
				  CONFIG_MODEM_QUECTEL_BC660_INIT_PRIORITY,
				  &api_funcs, MDM_MAX_DATA_LENGTH);

/* Register NET sockets. */
NET_SOCKET_OFFLOAD_REGISTER(quectel_bc660, CONFIG_NET_SOCKETS_OFFLOAD_PRIORITY,
